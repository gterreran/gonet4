...
def is_saturated(file_path):
    ...
    if count > 100:
        print("More than 100 elements are greater than 4095. Image is Saturated.")
    else:
        print("100 or fewer elements are greater than 4095. Image is not Saturated.")
...
for filename in os.listdir(scratch_dir):
   if filename.endswith(".jpg"):
     ...
     # Work here for saturation test?
     is_saturated(scratch_dir + filename)
